...
class AIResponses:
    ...
    def generate_ai_response(self, role, user_message):
        try:
            ...
            log_error("Exception occurred while generating AI response", exc_info=True)
